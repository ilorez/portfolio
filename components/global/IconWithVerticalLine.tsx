...
const IconWithVerticalLine = ({
  ...
  <div className="relative w-14 shrink-0 self-stretch min-h-0">
    ...
    {/* Full-height line: absolute from below icon to bottom of section */}
    <div
      className={cn(
        'absolute left-1/2 top-14 -translate-x-1/2 bottom-0 w-1 rounded-full min-h-[2rem]',
